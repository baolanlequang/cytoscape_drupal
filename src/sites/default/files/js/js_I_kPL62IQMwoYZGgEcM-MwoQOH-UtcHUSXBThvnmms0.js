    ...
    Drupal.behaviors.csdisplayUpload = {
       attach: function(context, settings) {
           $('.cy', context).each(function() {
            //  var file = $('#bl_cytoscaple_tmp_file').find('.file')('a').attr('href')
            var file = $('#bl_cytoscaple_tmp_file').find('.file').children('a').attr('href')
            if (file) {
              $.getJSON(file, function(cytoscapeData) {
